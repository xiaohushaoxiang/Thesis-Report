...
\begin{enumerate}
	...
	\item \textbf{Scoring }\\
	With the scoring stage the "peakiness" of a given sample is evaluated. The result of this stage should increase the magnitude of any peaks. This makes it easier for subsequent peak detection. The scoring used is that of mean difference 
	\begin{equation}
